    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 font-heading">No has iniciat sessió</h2>
          <p className="text-gray-500 mt-2">Inicia sessió per veure el teu perfil.</p>
        </div>
      </div>
    );
  }
